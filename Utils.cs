...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        public static string ServerIpAddress
        {
            get
            {
                switch (MachineName)
                {
                    case MACHINE_NAME_NIGHT55:
                        return MACHINE_IP_KNIGHT55;
                    case MACHINE_NAME_KNIGHT55:
                        return MACHINE_IP_NIGHT55;
                    default:
                        return String.Empty;
                }
            }
        ...
        public static string PrimaryAutoSwitchDefault
        {
            get
            {
                ...
                {
                    case MACHINE_NAME_NIGHT55:
                        return @"\\?\hid#vid_0557&pid_2405&mi_01#7&3b2da764&0&0000#{4d1e55b2-f16f-11cf-88cb-001111000030}";
                    case MACHINE_NAME_KNIGHT55:
                        return @"\\?\hid#vid_0557&pid_2405&mi_01#7&2a6abc53&0&0000#{4d1e55b2-f16f-11cf-88cb-001111000030}";
                    default:
                        return null;
                }
            }
        ...
        public static string SecondaryAutoSwitchDefault
        {
            get
            {
                ...
                {
                    case MACHINE_NAME_NIGHT55:
                        return @"\\?\hid#vid_0557&pid_2405&mi_01#7&60d021c&0&0000#{4d1e55b2-f16f-11cf-88cb-001111000030}";
                    case MACHINE_NAME_KNIGHT55:
                        return @"\\?\hid#vid_0557&pid_2405&mi_01#7&4c24ac6&0&0000#{4d1e55b2-f16f-11cf-88cb-001111000030}";
                    default:
                        return null;
                }
            }
        ...
        public static string VOICEMEETER_EXECUTABLE_NAME
        {
            get
            {
                string voiceMeeterProcessName;
                switch (MachineName)
                {
                    case MACHINE_NAME_KNIGHT55:
                    case MACHINE_NAME_NIGHT55:
                    case MACHINE_NAME_SWWWOOBY:
                        voiceMeeterProcessName = "voicemeeter8x64";
                        break;
                    default:
                        voiceMeeterProcessName = "voicemeeterpro";
                        break;
                }
                return $@"{voiceMeeterProcessName}";
            }
        }
        ...
        public static string StarCitizenLauncherProcessName = "RSI Launcher";

        public static string StarCitizenLauncherExecutablePath = $@"{GetProgramFilesX64}\Roberts Space Industries\{StarCitizenLauncherProcessName}\{StarCitizenLauncherProcessName}.exe";
        ...
        public static bool IsForegroundProcessStarCitizen
        {
            get
            {
                return IsForegroundProcess(Utils.STAR_CITIZEN_PROCESS_NAME);
            }
        }
        ...
        public static string Quote(object value)
        {
            ...
            if (value is StringBuilder) return $"\"{value.ToString()}\"";
        ...
        public static string[] LINEFEED_SEPARATOR = new string[] { "\r\n" };
        ...
        static RegistryKey GetBaseKeyFromKeyName(string registryPath)
        {
            ...
            switch (hiveName.ToUpper())
            {
                ...
                default:
                    throw new ArgumentException("Invalid registry hive.");
            }
        }
        ...
        public static bool IsAnyCpu2(Assembly assembly = null)
        {
            if (assembly == null)
            {
        ...
        public static bool IsForegroundProcess(string processName)
        {
            try
            {
                ...
                if (hwnd != nint.Zero)
                {
                    ...
                    //Log(LogLevel.Verbose, $"IsForegroundProcess: PID={pid}, processName={Utils.Quote(foregroundProcessName)}");
